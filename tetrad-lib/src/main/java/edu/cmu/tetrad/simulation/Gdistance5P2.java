...
public class Gdistance5P2 {
    ...
    public Gdistance5P2(DataSet locationMap, double xDist, double yDist, double zDist){
    ...
    public List<Double> distances(Graph graph1, Graph graph2) {
        ...
        final Vicinity5 vicinity = new Vicinity5(graph2edges,locationMap,0,100,0,100,0,100,xDist,yDist,zDist);
    ...
    class FindLeastDistanceTask  {
        ...
        private FindLeastDistanceTask(final Vicinity5 vicinity) {
